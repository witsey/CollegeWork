...
void addString() {
    ...
    ++indx;
    newString = new CharArray(readString());
    
    strings[indx] = *newString;
}
...
void getFirstAndLastChars() {
    ...
    cout << "\nThe first letter in the string is: '" << strings[indx].first() << "'" << endl; 
    cout << "The last letter in the string is: '" << strings[indx].last() << "'" << endl;
}
